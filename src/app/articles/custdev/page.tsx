...
const articleNav = [
  ...
  { id: "practical-guide", label: "Практическое руководство" },
  ...
  return (
    <main className="bg-white min-h-screen text-neutral-900">
      ...
      >
        ...
        <h2 className="text-[clamp(1.75rem,4.8vw,2.6rem)] font-extrabold mb-4 tracking-tight">
          Практическое руководство по CustDev интервью
        </h2>

        <p className="text-neutral-500 mb-10 max-w-2xl text-[clamp(1rem,2.3vw,1.125rem)] leading-relaxed">
          Ниже собраны ключевые вопросы, ошибки и логика анализа, чтобы вы могли
          сразу применить CustDev в своей работе без перехода на другую страницу.
        </p>

        <div className="rounded-3xl border border-neutral-200 bg-neutral-50 p-6 sm:p-8 mb-8 shadow-sm">
          <h3 className="text-xl sm:text-2xl font-bold mb-4">
            Как подготовиться к интервью
          </h3>

          <ul className="space-y-3 text-neutral-700 text-sm sm:text-[15px] leading-relaxed">
            <li>— Заранее определите, какие гипотезы хотите проверить.</li>
            <li>— Подготовьте таблицу для фиксации ответов.</li>
            <li>— Запросите согласие на запись разговора.</li>
            <li>— Адаптируйте список вопросов под вашу нишу и сегмент.</li>
          </ul>
        </div>

        <div className="rounded-3xl border border-neutral-200 bg-white p-6 sm:p-8 shadow-lg mb-8">
          <h3 className="text-xl sm:text-2xl font-bold mb-6">
            10 ключевых вопросов для CustDev интервью
          </h3>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {custdevQuestions.map((question, index) => (
              <div
                key={index}
                className="rounded-2xl border border-neutral-200 p-4 sm:p-5 bg-neutral-50"
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          <div className="rounded-3xl border border-neutral-200 bg-white p-6 sm:p-8 shadow-lg">
            <h3 className="text-xl font-bold mb-4">
              Типичные ошибки в интервью
            </h3>

            <ul className="space-y-3 text-neutral-700 text-sm sm:text-[15px] leading-relaxed">
              <li>— Не спрашивайте о будущем, люди часто выдают социально желаемые ответы.</li>
              <li>— Не перебивайте респондента, дайте ему договорить.</li>
              <li>— Не задавайте наводящих вопросов с готовым ответом внутри.</li>
              <li>— Не забывайте вести запись, иначе потеряются нюансы.</li>
            </ul>
          </div>
          ...
          <div className="rounded-3xl border border-neutral-200 bg-white p-6 sm:p-8 shadow-lg">
            ...
            <ul className="space-y-3 text-neutral-700 text-sm sm:text-[15px] leading-relaxed">
              <li>— Какую задачу человек хочет решить с помощью продукта.</li>
              <li>— Из какой точки он хочет выйти и в какую прийти.</li>
              <li>— Какое состояние хочет получить в результате.</li>
              <li>— Что мешает ему решить проблему самостоятельно.</li>
            </ul>
          </div>
        </div>

        <div className="mt-8 rounded-3xl shadow-lg p-6 sm:p-8 md:p-10 bg-blue-600 text-center">
          <p className="text-white text-[clamp(1rem,2.5vw,1.25rem)] leading-relaxed font-medium max-w-2xl mx-auto mb-6">
            CustDev работает лучше всего тогда, когда вы не пытаетесь подтвердить
            свою идею, а честно исследуете реальный опыт человека.
          </p>

          <Link
            href="/contact"
            className="inline-flex px-6 py-3 rounded-2xl bg-white text-blue-600 font-bold text-sm sm:text-base hover:bg-blue-50 transition"
          >
            Задать вопрос
          </Link>
        </div>
...
const custdevQuestions = [
  "Почему для вас вообще важна эта тема?",
  "Какое событие стало последней каплей для принятия решения об изменениях?",
  "Как часто вас беспокоит эта проблема в повседневной жизни?",
  "С какими трудностями вы сталкиваетесь в этой сфере прямо сейчас?",
  "Что больше всего мешает решить этот вопрос?",
  "Почему ранее предпринятые попытки не сработали?",
  "Что будет, если вы оставите всё как есть и не решите проблему?",
  "Опишите свой идеальный результат: что вы хотите получить в итоге?",
  "По каким критериям вы обычно выбираете обучение, сервис или курс?",
  "Сколько стоило самое дорогое решение этой проблемы, которое вы уже покупали?",
];
